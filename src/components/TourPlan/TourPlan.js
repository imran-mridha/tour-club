...
const TourPlan = ({tour,handleActivities}) => {
  ...
  return (
      <div className='p-4 shadow-lg rounded-lg bg-white'>
        ...
        <button onClick={()=>handleActivities(tour)} className='bg-red-300 uppercase w-full mb-3 rounded-lg py-2 font-semibold'>Add to list</button>
    </div>
  );
};
